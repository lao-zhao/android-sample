package com.name.libs.utils.singleton;

import com.name.libs.utils.CommonUtil;
import com.name.libs.utils.ConfigUtil;
import com.name.libs.utils.LogUtil;
import com.name.libs.assists.sslcers.MySSLSocketFactory2;
import com.name.libs.assists.sslcers.TrustAllCerts;
import com.name.libs.assists.sslcers.TrustAllHostnameVerifier;
...
//            ssfFactory = sc.getSocketFactory();
            ssfFactory = new MySSLSocketFactory2(sc.getSocketFactory());
        } catch (Exception e) {
        }
        return ssfFactory;
    }
