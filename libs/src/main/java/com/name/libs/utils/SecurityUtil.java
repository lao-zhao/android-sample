...
public class SecurityUtil {
    ...
    private static final String ENCODINGTYPE = com.name.libs.utils.ConfigUtil.TextCode.GB2312;
    ...
    public static byte[] Encryption(byte[] key, String string) {
        ...
        try {
            ...
            com.name.libs.utils.LogUtil.exportLog(com.name.libs.utils.CommonUtil.getCName(new Exception()), com.name.libs.utils.CommonUtil.getMName(new
    ...
    public static byte[] getSecretKey(String key) {
        ...
        try {
            ...
            com.name.libs.utils.LogUtil.exportLog(com.name.libs.utils.CommonUtil.getCName(new Exception()), com.name.libs.utils.CommonUtil.getMName(new Exception()), "NoSuchPaddingException:" + e.getMessage(), true);
        }
